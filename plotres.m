...
legend('ship trajectory', 'Our model',...
    'FontSize', 12,'FontName','Times New Roman', 'FontWeight', 'bold')
savefig('C:\Users\ranyan\Desktop\results\results 4\tracking.fig')
...
legend('AIS points', 'Ship trajectory',...
    'FontSize', 12,'FontName','Times New Roman', 'FontWeight', 'bold')
savefig('C:\Users\ranyan\Desktop\results\results 4\zoomin.fig')
...
plot(t, (U.*(4))./0.5144444, 'r', 'lineWidth', 1.5);
hold on
...
xlabel('Time (days)',  'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold');
ylabel('\beta (rad)',  'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold');
hold on
beta = mod(pi+beta, 2*pi)- pi;
plot(t, beta, 'r', 'lineWidth', 1.5);

legend('\beta','FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold', 'location', 'Northeast');
savefig('C:\Users\ranyan\Desktop\results\results 4\command.fig')
...
set(gca,'linewidth',1);
set(gca,'FontName','Times New Roman', 'FontSize',12)
title('Roll motion', 'FontName','Times New Roman',  'FontSize',14, 'FontWeight', 'bold');
xlabel('Time (days)',  'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold');
ylabel('\phi (rad)',  'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold');
hold on
plot(t, phi, 'r', 'lineWidth', 1.5);
legend('\phi', 'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold', 'location', 'Northeast');
...
set(gca,'linewidth',1);
set(gca,'FontName','Times New Roman', 'FontSize',12)
title('Pitch motion', 'FontName','Times New Roman',  'FontSize',14, 'FontWeight', 'bold');
xlabel('Time (days)',  'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold');
ylabel('\theta (rad)',  'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold');
hold on
plot(t, theta, 'r', 'lineWidth', 1.5);
legend('\theta', 'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold', 'location', 'Northeast');
...
set(gca,'linewidth',1);
set(gca,'FontName','Times New Roman', 'FontSize',12)
title('Yaw motion', 'FontName','Times New Roman',  'FontSize',14, 'FontWeight', 'bold');
xlabel('Time (days)',  'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold');
...
savefig('C:\Users\ranyan\Desktop\results\results 4\eulerangle.fig')
...
hold on
% [v, chi, chi_d, t, x, y, propeller, thrust] = vcload('simulation_proposed_profile.mat');
plot(t, (v.*(4))./0.5144444, 'r', 'lineWidth', 1.5);
hold on
...
set(gca,'linewidth',1);
set(gca,'FontName','Times New Roman', 'FontSize',12)
title('Yaw velocity (rad/s)','FontName','Times New Roman',  'FontSize',14, 'FontWeight', 'bold')
xlabel('Time (days)',  'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold');
...
savefig('C:\Users\ranyan\Desktop\results\results 4\speed.fig')
...
% set(gca,'linewidth',1);
% set(gca,'FontName','Times New Roman', 'FontSize',12)
% title('Thruster No. 1','FontName','Times New Roman',  'FontSize',14, 'FontWeight', 'bold')
% xlabel('Time (days)',  'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold');
% ylabel('Rotation (rad/s)',  'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold');
% hold on
...
% set(gca,'linewidth',1);
% set(gca,'FontName','Times New Roman', 'FontSize',12)
% title('Thruster No. 2','FontName','Times New Roman',  'FontSize',14, 'FontWeight', 'bold')
% xlabel('Time (days)',  'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold');
% ylabel('Rotation (rad/s)',  'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold');
% hold on
...
function [U, chi, chi_d, omega_chi,t,u, v,w,phi,theta,beta, x, y, propeller, thrust] = vcload(filename)
data = load(filename);
out = data.out;
U = out.speed;
t = out.tout;
