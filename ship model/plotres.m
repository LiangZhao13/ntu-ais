...
legend('ship trajectory', 'Our model',...
    'FontSize', 12,'FontName','Times New Roman', 'FontWeight', 'bold')
savefig('results\results 4\tracking.fig')
...
legend('AIS points', 'Ship trajectory',...
    'FontSize', 12,'FontName','Times New Roman', 'FontWeight', 'bold')
savefig('results\results 4\zoomin.fig')
...
savefig('results\results 4\command.fig')
...
savefig('results\results 4\angle.fig')
...
savefig('results\results 4\velocity.fig')
