...
[U, chi, chi_d,chi_hat, omega_chi, omega_chi_d,t,u, v,r,psi,beta, x, y, delta_d, delta]  = vcload('data_1.mat');
t = t./3600/24;
...
legend('\omega_\chi','\omega_\chi_d', 'FontSize',12,'FontName','Times New Roman', 'FontWeight', 'bold', 'location', 'Southeast');
...
hold on
% [v, chi, chi_d, t, x, y, propeller, thrust] = vcload('simulation_proposed_profile.mat');
plot(t, u./0.5144444+7.7175/0.51444444, 'r', 'lineWidth', 1.5);
hold on
legend('u',  'FontSize',12,'FontWeight', 'bold', 'location', 'Southeast');
