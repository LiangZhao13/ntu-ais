...
azap50bxgn = 0.0 ; rtX . phk1si4gzc = 0.0 ; rtDW . mljze4pwl0 = false ; rtDW
. iw1j5thqrr = false ; rtDW . mlz0dzd5h3 = false ; rtDW . fjimdccq4p =
lagoav3iwa ; rtDW . adi32v00qw = false ; rtDW . gkr5vx1zx5 = lagoav3iwa ;
rtDW . mhvkskjfs0 = false ; rtDW . cuv3mcnkfb = false ; rtDW . kyv0fyn5jf =
false ; rtDW . mubxw11mvk = false ; rtDW . gayjctc4dn = false ; rtDW .
...
"2ba43140-f180-4c51-a219-a8e9658a42b8" , sigComplexity , & sigDims ,
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"db6082b6-619d-4964-b414-9d7959ccd73a" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
...
InstanceMap . fullPath , "507a4c23-c97a-4ebc-8d68-e42ea4f326f6" ,
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"6d8dc89c-0e0e-4121-876a-2642735f8f42" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"23e812c4-8fe0-4229-af44-4e8f5029aea9" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"7a9fd0f2-ca7e-4308-98fd-679fa8736741" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"fadcfdd2-7c4a-4987-8e36-89547cac0643" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"556a3359-e7dc-409e-9715-fe0b636d39f1" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
...
sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo . mmi .
InstanceMap . fullPath , "a478170d-762c-4809-a316-c64a2a92ed1f" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"e9de17e5-bfc7-4c5a-bb5a-61b271611460" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
...
sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo . mmi .
InstanceMap . fullPath , "daaf7da9-c804-4481-ac7a-2927c8c59f18" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
...
sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo . mmi .
InstanceMap . fullPath , "1229e348-fbb0-4fc0-a91a-81d32a51e5de" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
...
sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo . mmi .
InstanceMap . fullPath , "9f923afa-8749-47a7-8cea-309dcad71bed" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
...
sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo . mmi .
InstanceMap . fullPath , "708764e8-8667-4623-b9c0-be599a28da42" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
...
rt_dataMapInfo . mmi . InstanceMap . fullPath ,
"e4b3bd17-7ae5-4aca-9794-5afcfd358749" , sigComplexity , & sigDims ,
DIMENSIONS_MODE_FIXED , stCont , "" ) ; sdiCompleteAsyncioQueueCreation (
...
origWidth = 49 ; fromwksInfo -> origElSize = sizeof ( real_T ) ; fromwksInfo
...
rtDW . fjimdccq4p = lagoav3iwa ; if ( ! rtDW . mljze4pwl0 ) { rtDW .
m0kis4oha4 [ 0 ] = rtB . d25mgzrntl [ 3 ] ; rtDW . m0kis4oha4 [ 1 ] = rtB .
d25mgzrntl [ 4 ] ; rtDW . m0kis4oha4 [ 2 ] = 0.0 ; rtDW . m0kis4oha4 [ 3 ] =
0.0 ; rtDW . m0kis4oha4 [ 4 ] = 0.0 ; rtDW . mljze4pwl0 = true ; for ( i = 0
; i < 25 ; i ++ ) { rtDW . bfaw3qxqxr [ i ] = 0.0 ; } for ( i = 0 ; i < 5 ; i
++ ) { rtDW . bfaw3qxqxr [ i + 5 * i ] = 1.0 ; } rtDW . iw1j5thqrr = true ; }
...
; for ( i = 0 ; i < 5 ; i ++ ) { a21 += rtDW . bfaw3qxqxr [ 5 * i + b_k ] * (
real_T ) c [ 5 * r2 + i ] ; a22 += ( real_T ) c_b [ ( i << 1 ) + r2 ] * rtDW
. bfaw3qxqxr [ 5 * b_k + i ] ; } B_p [ b_k + 5 * r2 ] = a21 ; K [ r2 + ( b_k
...
) + r2 ] * rtDW . m0kis4oha4 [ b_k ] ; } tmp_p [ r2 ] = tmp [ r2 ] - a22 ; }
a21 = tmp_p [ 1 ] ; a22 = tmp_p [ 0 ] ; for ( r2 = 0 ; r2 < 5 ; r2 ++ ) { rtB
. a2jle11lq2 [ r2 ] = ( K [ r2 + 5 ] * a21 + K [ r2 ] * a22 ) + rtDW .
m0kis4oha4 [ r2 ] ; } for ( r2 = 0 ; r2 < 25 ; r2 ++ ) { b_I [ r2 ] = 0 ; }
...
* rtDW . bfaw3qxqxr [ 5 * r2 + b_k ] ; } IKC_p [ i + 5 * r2 ] = a21 ; } a21 =
...
} for ( r2 = 0 ; r2 < 25 ; r2 ++ ) { rtDW . bfaw3qxqxr [ r2 ] = IKC_p [ r2 ]
...
( elIdx = 0 ; elIdx < 49 ; ++ elIdx ) { ( & rtB . lk0bm5xw5m [ 0 ] ) [ elIdx
] = pDataValues [ 0 ] ; pDataValues += 1 ; } } } { real_T * pDataValues = (
real_T * ) rtDW . kj33gbqgqh . DataPtr ; { int_T elIdx ; for ( elIdx = 0 ;
elIdx < 49 ; ++ elIdx ) { ( & rtB . hleb2ewssu [ 0 ] ) [ elIdx ] =
pDataValues [ 0 ] ; pDataValues += 1 ; } } } if ( ssIsSampleHit ( rtS , 1 , 0
) ) { rtDW . dkc5vqz4gx = lagoav3iwa ; if ( ! rtDW . mhvkskjfs0 ) { rtDW .
owksmtgtzo = 0.0 ; rtDW . mubxw11mvk = true ; rtDW . oc0omgil0h = 1.0 ; rtDW
. mhvkskjfs0 = true ; rtDW . hqcskiqd0y = rtB . hleb2ewssu [ 0 ] ; rtDW .
cuv3mcnkfb = true ; rtDW . jiervi4iek = rtB . lk0bm5xw5m [ 0 ] ; rtDW .
kyv0fyn5jf = true ; printf ( "Active waypoints:\n" ) ; fflush ( stdout ) ;
printf ( "  (x%1.0f, y%1.0f) = (%.2f, %.2f) \n" , 1.0 , 1.0 , rtDW .
hqcskiqd0y , rtDW . jiervi4iek ) ; fflush ( stdout ) ; } if ( rtDW .
oc0omgil0h < 49.0 ) { a21 = rtB . hleb2ewssu [ ( int32_T ) ( rtDW .
oc0omgil0h + 1.0 ) - 1 ] ; v = rtB . lk0bm5xw5m [ ( int32_T ) ( rtDW .
oc0omgil0h + 1.0 ) - 1 ] ; } else { jxvtyyx4mw = muDoubleScalarAtan2 ( rtB .
lk0bm5xw5m [ 48 ] - rtB . lk0bm5xw5m [ 47 ] , rtB . hleb2ewssu [ 48 ] - rtB .
hleb2ewssu [ 47 ] ) ; a21 = 1.0E+10 * muDoubleScalarCos ( jxvtyyx4mw ) + rtB
. hleb2ewssu [ 48 ] ; v = 1.0E+10 * muDoubleScalarSin ( jxvtyyx4mw ) + rtB .
lk0bm5xw5m [ 48 ] ; } r = muDoubleScalarAtan2 ( v - rtDW . jiervi4iek , a21 -
rtDW . hqcskiqd0y ) ; a22 = - ( rtB . d25mgzrntl [ 3 ] - rtDW . hqcskiqd0y )
* muDoubleScalarSin ( r ) + ( rtB . d25mgzrntl [ 4 ] - rtDW . jiervi4iek ) *
muDoubleScalarCos ( r ) ; jxvtyyx4mw = a21 - rtDW . hqcskiqd0y ; delta_c = v
- rtDW . jiervi4iek ; if ( ( muDoubleScalarSqrt ( jxvtyyx4mw * jxvtyyx4mw +
delta_c * delta_c ) - ( ( rtB . d25mgzrntl [ 3 ] - rtDW . hqcskiqd0y ) *
muDoubleScalarCos ( r ) + ( rtB . d25mgzrntl [ 4 ] - rtDW . jiervi4iek ) *
muDoubleScalarSin ( r ) ) < rtP . R_switch_Value ) && ( rtDW . oc0omgil0h <
49.0 ) ) { rtDW . oc0omgil0h ++ ; rtDW . hqcskiqd0y = a21 ; rtDW . jiervi4iek
= v ; printf ( "  (x%1.0f, y%1.0f) = (%.2f, %.2f) \n" , rtDW . oc0omgil0h ,
rtDW . oc0omgil0h , rtDW . hqcskiqd0y , rtDW . jiervi4iek ) ; fflush ( stdout
) ; } rtB . irc5tjl1ah = r - muDoubleScalarAtan ( ( rtP . kappa_Value * rtDW
. owksmtgtzo + a22 ) * ( 1.0 / rtP . Delta_Value ) ) ; a21 = rtP .
kappa_Value * rtDW . owksmtgtzo + a22 ; rtDW . owksmtgtzo += rtP . h_Value *
rtP . Delta_Value * a22 / ( rtP . Delta_Value * rtP . Delta_Value + a21 * a21
) ; } rtB . ncqyk10zdm = ( muDoubleScalarMod ( ( rtB . irc5tjl1ah - rtB .
...
rtdwDataFieldNames [ 21 ] = { "rtDW.oc0omgil0h" , "rtDW.hqcskiqd0y" ,
"rtDW.jiervi4iek" , "rtDW.owksmtgtzo" , "rtDW.m0kis4oha4" , "rtDW.bfaw3qxqxr"
, "rtDW.gkr5vx1zx5" , "rtDW.dkc5vqz4gx" , "rtDW.fjimdccq4p" ,
"rtDW.h5x2psv2rm" , "rtDW.adphgackqq" , "rtDW.npo3ez1xrm" , "rtDW.adi32v00qw"
, "rtDW.gayjctc4dn" , "rtDW.mhvkskjfs0" , "rtDW.cuv3mcnkfb" ,
"rtDW.kyv0fyn5jf" , "rtDW.mubxw11mvk" , "rtDW.mlz0dzd5h3" , "rtDW.mljze4pwl0"
, "rtDW.iw1j5thqrr" , } ; mxArray * rtdwData = mxCreateStructMatrix ( 1 , 1 ,
21 , rtdwDataFieldNames ) ;
mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray ( rtdwData , 0 ,
0 , ( const void * ) & ( rtDW . oc0omgil0h ) , sizeof ( rtDW . oc0omgil0h ) )
; mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray ( rtdwData , 0
, 1 , ( const void * ) & ( rtDW . hqcskiqd0y ) , sizeof ( rtDW . hqcskiqd0y )
) ; mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray ( rtdwData ,
0 , 2 , ( const void * ) & ( rtDW . jiervi4iek ) , sizeof ( rtDW . jiervi4iek
) ) ; mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray ( rtdwData
, 0 , 3 , ( const void * ) & ( rtDW . owksmtgtzo ) , sizeof ( rtDW .
owksmtgtzo ) ) ; mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray
( rtdwData , 0 , 4 , ( const void * ) & ( rtDW . m0kis4oha4 ) , sizeof ( rtDW
. m0kis4oha4 ) ) ;
mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray ( rtdwData , 0 ,
5 , ( const void * ) & ( rtDW . bfaw3qxqxr ) , sizeof ( rtDW . bfaw3qxqxr ) )
; mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray ( rtdwData , 0
...
( rtdwData , 0 , 12 , ( const void * ) & ( rtDW . adi32v00qw ) , sizeof (
rtDW . adi32v00qw ) ) ;
mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray ( rtdwData , 0 ,
13 , ( const void * ) & ( rtDW . gayjctc4dn ) , sizeof ( rtDW . gayjctc4dn )
) ; mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray ( rtdwData ,
0 , 14 , ( const void * ) & ( rtDW . mhvkskjfs0 ) , sizeof ( rtDW .
mhvkskjfs0 ) ) ; mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray
( rtdwData , 0 , 15 , ( const void * ) & ( rtDW . cuv3mcnkfb ) , sizeof (
rtDW . cuv3mcnkfb ) ) ;
mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray ( rtdwData , 0 ,
16 , ( const void * ) & ( rtDW . kyv0fyn5jf ) , sizeof ( rtDW . kyv0fyn5jf )
) ; mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray ( rtdwData ,
0 , 17 , ( const void * ) & ( rtDW . mubxw11mvk ) , sizeof ( rtDW .
mubxw11mvk ) ) ; mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray
( rtdwData , 0 , 18 , ( const void * ) & ( rtDW . mlz0dzd5h3 ) , sizeof (
rtDW . mlz0dzd5h3 ) ) ;
mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray ( rtdwData , 0 ,
19 , ( const void * ) & ( rtDW . mljze4pwl0 ) , sizeof ( rtDW . mljze4pwl0 )
) ; mr_demoMarinerPathFollowingCourseControl_cacheDataAsMxArray ( rtdwData ,
0 , 20 , ( const void * ) & ( rtDW . iw1j5thqrr ) , sizeof ( rtDW .
iw1j5thqrr ) ) ; mxSetFieldByNumber ( ssDW , 0 , 1 , rtdwData ) ; } return
...
mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( ( void * )
& ( rtDW . oc0omgil0h ) , rtdwData , 0 , 0 , sizeof ( rtDW . oc0omgil0h ) ) ;
mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( ( void * )
& ( rtDW . hqcskiqd0y ) , rtdwData , 0 , 1 , sizeof ( rtDW . hqcskiqd0y ) ) ;
mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( ( void * )
& ( rtDW . jiervi4iek ) , rtdwData , 0 , 2 , sizeof ( rtDW . jiervi4iek ) ) ;
mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( ( void * )
& ( rtDW . owksmtgtzo ) , rtdwData , 0 , 3 , sizeof ( rtDW . owksmtgtzo ) ) ;
mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( ( void * )
& ( rtDW . m0kis4oha4 ) , rtdwData , 0 , 4 , sizeof ( rtDW . m0kis4oha4 ) ) ;
mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( ( void * )
& ( rtDW . bfaw3qxqxr ) , rtdwData , 0 , 5 , sizeof ( rtDW . bfaw3qxqxr ) ) ;
mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( ( void * )
...
* ) & ( rtDW . adi32v00qw ) , rtdwData , 0 , 12 , sizeof ( rtDW . adi32v00qw
) ) ; mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( (
void * ) & ( rtDW . gayjctc4dn ) , rtdwData , 0 , 13 , sizeof ( rtDW .
gayjctc4dn ) ) ;
mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( ( void * )
& ( rtDW . mhvkskjfs0 ) , rtdwData , 0 , 14 , sizeof ( rtDW . mhvkskjfs0 ) )
; mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( ( void *
) & ( rtDW . cuv3mcnkfb ) , rtdwData , 0 , 15 , sizeof ( rtDW . cuv3mcnkfb )
) ; mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( ( void
* ) & ( rtDW . kyv0fyn5jf ) , rtdwData , 0 , 16 , sizeof ( rtDW . kyv0fyn5jf
) ) ; mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( (
void * ) & ( rtDW . mubxw11mvk ) , rtdwData , 0 , 17 , sizeof ( rtDW .
mubxw11mvk ) ) ;
mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( ( void * )
& ( rtDW . mlz0dzd5h3 ) , rtdwData , 0 , 18 , sizeof ( rtDW . mlz0dzd5h3 ) )
; mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( ( void *
) & ( rtDW . mljze4pwl0 ) , rtdwData , 0 , 19 , sizeof ( rtDW . mljze4pwl0 )
) ; mr_demoMarinerPathFollowingCourseControl_restoreDataFromMxArray ( ( void
* ) & ( rtDW . iw1j5thqrr ) , rtdwData , 0 , 20 , sizeof ( rtDW . iw1j5thqrr
) ) ; } } mxArray *
...
ssSetNumBlockIO ( rtS , 16 ) ; ssSetNumBlockParams ( rtS , 142 ) ; } void
MdlInitializeSampleTimes ( void ) { ssSetSampleTime ( rtS , 0 , 0.0 ) ;
ssSetSampleTime ( rtS , 1 , 0.1 ) ; ssSetOffsetTime ( rtS , 0 , 0.0 ) ;
ssSetOffsetTime ( rtS , 1 , 0.0 ) ; } void raccel_set_checksum ( ) {
ssSetChecksumVal ( rtS , 0 , 2900496539U ) ; ssSetChecksumVal ( rtS , 1 ,
270298566U ) ; ssSetChecksumVal ( rtS , 2 , 2306768164U ) ; ssSetChecksumVal
( rtS , 3 , 2532363302U ) ; }
#if defined(_MSC_VER)
#pragma optimize( "", off )
#endif
...
d25mgzrntl [ i ] = 0.0 ; } for ( i = 0 ; i < 49 ; i ++ ) { rtB . lk0bm5xw5m [
i ] = 0.0 ; } for ( i = 0 ; i < 49 ; i ++ ) { rtB . hleb2ewssu [ i ] = 0.0 ;
} for ( i = 0 ; i < 7 ; i ++ ) { rtB . fjukfd0ml0 [ i ] = 0.0 ; } for ( i = 0
; i < 7 ; i ++ ) { rtB . otagkty1sc [ i ] = 0.0 ; } for ( i = 0 ; i < 5 ; i
...
( DW ) ) ; rtDW . oc0omgil0h = 0.0 ; rtDW . hqcskiqd0y = 0.0 ; rtDW .
jiervi4iek = 0.0 ; rtDW . owksmtgtzo = 0.0 ; { int32_T i ; for ( i = 0 ; i <
5 ; i ++ ) { rtDW . m0kis4oha4 [ i ] = 0.0 ; } } { int32_T i ; for ( i = 0 ;
i < 25 ; i ++ ) { rtDW . bfaw3qxqxr [ i ] = 0.0 ; } } } { static
...
ssSetTFinal ( rtS , 50000.0 ) ; ssSetStepSize ( rtS , 0.1 ) ;
...
contStatesDisabled ) ; } ssSetChecksumVal ( rtS , 0 , 2900496539U ) ;
ssSetChecksumVal ( rtS , 1 , 270298566U ) ; ssSetChecksumVal ( rtS , 2 ,
2306768164U ) ; ssSetChecksumVal ( rtS , 3 , 2532363302U ) ; { static const
