...
"demoMarinerPathFollowingCourseControl/ILOS/is_active_c7_mssSimulink" ) ,
TARGET_STRING ( "is_active_c7_mssSimulink" ) , 0 , 1 , 0 , 0 , 0 } , { 2 , 0
, TARGET_STRING ( "demoMarinerPathFollowingCourseControl/x0" ) ,
TARGET_STRING ( "" ) , 0 , 0 , 1 , 0 , 1 } , { 3 , 0 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/From Workspace" ) , TARGET_STRING ( ""
) , 0 , 0 , 2 , 0 , 2 } , { 4 , 0 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/From Workspace1" ) , TARGET_STRING (
"" ) , 0 , 0 , 2 , 0 , 2 } , { 5 , 0 , TARGET_STRING (
...
TARGET_STRING ( "beta_c" ) , 0 , 0 , 0 , 0 , 2 } , { 10 , 1 , TARGET_STRING (
 ...
 "demoMarinerPathFollowingCourseControl/Discerte-time EKF for SOG and COG/Five-state EKF for North-East positions/is_active_c9_mssSimulink"
) , TARGET_STRING ( "is_active_c9_mssSimulink" ) , 0 , 1 , 0 , 0 , 0 } , { 12
, 0 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/LOS observer/Sum" ) , TARGET_STRING (
"" ) , 0 , 0 , 0 , 0 , 2 } , { 13 , 0 , TARGET_STRING (
...
TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 15 , 3 , TARGET_STRING (
 "demoMarinerPathFollowingCourseControl/Mariner class cargo ship (mariner.m)/MATLAB Function"
) , TARGET_STRING ( "" ) , 0 , 0 , 1 , 0 , 2 } , { 16 , 3 , TARGET_STRING (
 "demoMarinerPathFollowingCourseControl/Mariner class cargo ship (mariner.m)/MATLAB Function"
) , TARGET_STRING ( "" ) , 1 , 0 , 0 , 0 , 2 } , { 17 , 0 , TARGET_STRING (
 "demoMarinerPathFollowingCourseControl/Mariner class cargo ship (mariner.m)/MATLAB Function/is_active_c4_mssSimulink"
) , TARGET_STRING ( "is_active_c4_mssSimulink" ) , 0 , 1 , 0 , 0 , 2 } , { 18
, 0 , TARGET_STRING (
...
"K_nomoto" ) , 0 , 0 , 0 } , { 20 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Course autopilot " ) , TARGET_STRING (
"Kp" ) , 0 , 0 , 0 } , { 21 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Course autopilot " ) , TARGET_STRING (
"Td" ) , 0 , 0 , 0 } , { 22 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Course autopilot " ) , TARGET_STRING (
"Ti" ) , 0 , 0 , 0 } , { 23 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Discerte-time EKF for SOG and COG" ) ,
TARGET_STRING ( "alpha_1" ) , 0 , 0 , 0 } , { 24 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Discerte-time EKF for SOG and COG" ) ,
TARGET_STRING ( "alpha_2" ) , 0 , 0 , 0 } , { 25 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Discerte-time EKF for SOG and COG" ) ,
TARGET_STRING ( "Qd" ) , 0 , 4 , 0 } , { 26 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Discerte-time EKF for SOG and COG" ) ,
TARGET_STRING ( "Rd" ) , 0 , 4 , 0 } , { 27 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Discerte-time EKF for SOG and COG" ) ,
TARGET_STRING ( "h_samp" ) , 0 , 0 , 0 } , { 28 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/LOS observer" ) , TARGET_STRING (
"K_f" ) , 0 , 0 , 0 } , { 29 , TARGET_STRING (
...
, 0 , 0 } , { 32 , TARGET_STRING ( "demoMarinerPathFollowingCourseControl/h"
...
, 1 , 0 } , { 35 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/From Workspace" ) , TARGET_STRING (
"Time0" ) , 0 , 0 , 0 } , { 36 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/From Workspace" ) , TARGET_STRING (
"Data0" ) , 0 , 2 , 0 } , { 37 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/From Workspace1" ) , TARGET_STRING (
"Time0" ) , 0 , 0 , 0 } , { 38 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/From Workspace1" ) , TARGET_STRING (
"Data0" ) , 0 , 2 , 0 } , { 39 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Gain" ) , TARGET_STRING ( "Gain" ) , 0
, 0 , 0 } , { 40 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Saturation1" ) , TARGET_STRING (
"UpperLimit" ) , 0 , 0 , 0 } , { 41 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Saturation1" ) , TARGET_STRING (
"LowerLimit" ) , 0 , 0 , 0 } , { 42 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Course autopilot /Integral" ) ,
TARGET_STRING ( "A" ) , 0 , 0 , 0 } , { 43 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Course autopilot /Integral" ) ,
TARGET_STRING ( "C" ) , 0 , 0 , 0 } , { 44 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/LOS observer/         " ) ,
TARGET_STRING ( "A" ) , 0 , 0 , 0 } , { 45 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/LOS observer/         " ) ,
TARGET_STRING ( "C" ) , 0 , 0 , 0 } , { 46 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/LOS observer/Differentiator" ) ,
TARGET_STRING ( "A" ) , 0 , 0 , 0 } , { 47 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/LOS observer/Differentiator" ) ,
TARGET_STRING ( "C" ) , 0 , 0 , 0 } , { 48 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/LOS observer/Differentiator" ) ,
TARGET_STRING ( "D" ) , 0 , 0 , 0 } , { 49 , TARGET_STRING (
...
static void * rtDataAddrMap [ ] = { & rtB . irc5tjl1ah , & rtDW . fu5xt1yxiq
, & rtB . fjukfd0ml0 [ 0 ] , & rtB . lk0bm5xw5m [ 0 ] , & rtB . hleb2ewssu [
0 ] , & rtB . an2daryais , & rtB . h2tvvxrgwg , & rtB . o4uvmnpinp , & rtB .
gvtucr52ij , & rtB . ngqggygexp , & rtB . a2jle11lq2 [ 0 ] , & rtDW .
lkbtsbbn1e , & rtB . ncqyk10zdm , & rtB . biizpmf3bn , & rtB . n5pvzdd33j , &
rtB . otagkty1sc [ 0 ] , & rtB . ocn4o1graj , & rtDW . jp1mjj1nai , & rtB .
d25mgzrntl [ 0 ] , & rtP . Courseautopilot_K_nomoto , & rtP .
Courseautopilot_Kp , & rtP . Courseautopilot_Td , & rtP . Courseautopilot_Ti
, & rtP . DiscertetimeEKFforSOGandCOG_alpha_1 , & rtP .
...
Delta_Value , & rtP . R_switch_Value , & rtP . U0_Value , & rtP . h_Value , &
rtP . kappa_Value , & rtP . x0_Value [ 0 ] , & rtP . FromWorkspace_Time0 , &
rtP . FromWorkspace_Data0 [ 0 ] , & rtP . FromWorkspace1_Time0 , & rtP .
FromWorkspace1_Data0 [ 0 ] , & rtP . Gain_Gain , & rtP . Saturation1_UpperSat
, & rtP . Saturation1_LowerSat , & rtP . Integral_A , & rtP . Integral_C , &
rtP . _A , & rtP . _C , & rtP . Differentiator_A , & rtP . Differentiator_C ,
& rtP . Differentiator_D , & rtP . Constant_Value , & rtP . Constant1_Value ,
& rtP . Constant_Value_pwerxxgmrl , & rtP . Constant1_Value_gv1s2zl30d , } ;
...
rtDimensionArray [ ] = { 1 , 1 , 7 , 1 , 116 , 1 , 5 , 1 , 2 , 2 } ; static
const real_T rtcapiStoredFloats [ ] = { 0.1 , 0.0 } ; static const
rtwCAPI_FixPtMap rtFixPtMap [ ] = { { ( NULL ) , ( NULL ) ,
rtwCAPI_FIX_RESERVED , 0 , 0 , ( boolean_T ) 0 } , } ; static const
rtwCAPI_SampleTimeMap rtSampleTimeMap [ ] = { { ( const void * ) &
rtcapiStoredFloats [ 0 ] , ( const void * ) & rtcapiStoredFloats [ 1 ] , (
int8_T ) 1 , ( uint8_T ) 0 } , { ( NULL ) , ( NULL ) , 2 , 0 } , { ( const
void * ) & rtcapiStoredFloats [ 1 ] , ( const void * ) & rtcapiStoredFloats [
1 ] , ( int8_T ) 0 , ( uint8_T ) 0 } } ; static
rtwCAPI_ModelMappingStaticInfo mmiStatic = { { rtBlockSignals , 19 ,
rtRootInputs , 0 , rtRootOutputs , 0 } , { rtBlockParameters , 34 ,
rtModelParameters , 0 } , { ( NULL ) , 0 } , { rtDataTypeMap , rtDimensionMap
, rtFixPtMap , rtElementMap , rtSampleTimeMap , rtDimensionArray } , "float"
, { 3672248073U , 933846276U , 3962722724U , 3591176389U } , ( NULL ) , 0 , (
