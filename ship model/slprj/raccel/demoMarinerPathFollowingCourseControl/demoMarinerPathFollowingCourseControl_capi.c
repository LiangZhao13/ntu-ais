...
"demoMarinerPathFollowingCourseControl/ILOS guidance law for heading autopilot"
...
TARGET_STRING ( "beta_c" ) , 0 , 0 , 0 , 0 , 2 } , { 9 , 1 , TARGET_STRING (
...
TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 13 , 3 , TARGET_STRING (
 "demoMarinerPathFollowingCourseControl/Mariner class cargo ship (mariner.m)/MATLAB Function"
) , TARGET_STRING ( "" ) , 0 , 0 , 1 , 0 , 2 } , { 14 , 3 , TARGET_STRING (
 "demoMarinerPathFollowingCourseControl/Mariner class cargo ship (mariner.m)/MATLAB Function"
) , TARGET_STRING ( "" ) , 1 , 0 , 0 , 0 , 2 } , { 15 , 0 , TARGET_STRING (
...
"K_nomoto" ) , 0 , 0 , 0 } , { 17 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Course autopilot " ) , TARGET_STRING (
"Kp" ) , 0 , 0 , 0 } , { 18 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Course autopilot " ) , TARGET_STRING (
"Td" ) , 0 , 0 , 0 } , { 19 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Course autopilot " ) , TARGET_STRING (
"Ti" ) , 0 , 0 , 0 } , { 20 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Discerte-time EKF for SOG and COG" ) ,
TARGET_STRING ( "alpha_1" ) , 0 , 0 , 0 } , { 21 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Discerte-time EKF for SOG and COG" ) ,
TARGET_STRING ( "alpha_2" ) , 0 , 0 , 0 } , { 22 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Discerte-time EKF for SOG and COG" ) ,
TARGET_STRING ( "Qd" ) , 0 , 4 , 0 } , { 23 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Discerte-time EKF for SOG and COG" ) ,
TARGET_STRING ( "Rd" ) , 0 , 4 , 0 } , { 24 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Discerte-time EKF for SOG and COG" ) ,
TARGET_STRING ( "h_samp" ) , 0 , 0 , 0 } , { 25 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/LOS observer" ) , TARGET_STRING (
"K_f" ) , 0 , 0 , 0 } , { 26 , TARGET_STRING (
...
, 0 , 0 } , { 29 , TARGET_STRING ( "demoMarinerPathFollowingCourseControl/h"
...
"demoMarinerPathFollowingCourseControl/From Workspace" ) , TARGET_STRING (
"Time0" ) , 0 , 0 , 0 } , { 33 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/From Workspace" ) , TARGET_STRING (
"Data0" ) , 0 , 2 , 0 } , { 34 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/From Workspace1" ) , TARGET_STRING (
"Time0" ) , 0 , 0 , 0 } , { 35 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/From Workspace1" ) , TARGET_STRING (
"Data0" ) , 0 , 2 , 0 } , { 36 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Gain" ) , TARGET_STRING ( "Gain" ) , 0
, 0 , 0 } , { 37 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Saturation1" ) , TARGET_STRING (
"UpperLimit" ) , 0 , 0 , 0 } , { 38 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/Saturation1" ) , TARGET_STRING (
"LowerLimit" ) , 0 , 0 , 0 } , { 39 , TARGET_STRING (
...
"demoMarinerPathFollowingCourseControl/LOS observer/         " ) ,
TARGET_STRING ( "A" ) , 0 , 0 , 0 } , { 42 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/LOS observer/         " ) ,
TARGET_STRING ( "C" ) , 0 , 0 , 0 } , { 43 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/LOS observer/Differentiator" ) ,
TARGET_STRING ( "A" ) , 0 , 0 , 0 } , { 44 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/LOS observer/Differentiator" ) ,
TARGET_STRING ( "C" ) , 0 , 0 , 0 } , { 45 , TARGET_STRING (
"demoMarinerPathFollowingCourseControl/LOS observer/Differentiator" ) ,
TARGET_STRING ( "D" ) , 0 , 0 , 0 } , { 46 , TARGET_STRING (
...
static void * rtDataAddrMap [ ] = { & rtB . irc5tjl1ah , & rtB . fjukfd0ml0 [
0 ] , & rtB . lk0bm5xw5m [ 0 ] , & rtB . hleb2ewssu [ 0 ] , & rtB .
an2daryais , & rtB . h2tvvxrgwg , & rtB . o4uvmnpinp , & rtB . gvtucr52ij , &
rtB . ngqggygexp , & rtB . a2jle11lq2 [ 0 ] , & rtB . ncqyk10zdm , & rtB .
biizpmf3bn , & rtB . n5pvzdd33j , & rtB . otagkty1sc [ 0 ] , & rtB .
ocn4o1graj , & rtB . d25mgzrntl [ 0 ] , & rtP . Courseautopilot_K_nomoto , &
rtP . Courseautopilot_Kp , & rtP . Courseautopilot_Td , & rtP .
Courseautopilot_Ti , & rtP . DiscertetimeEKFforSOGandCOG_alpha_1 , & rtP .
...
rtDimensionArray [ ] = { 1 , 1 , 7 , 1 , 49 , 1 , 5 , 1 , 2 , 2 } ; static
...
, { 2900496539U , 270298566U , 2306768164U , 2532363302U } , ( NULL ) , 0 , (
